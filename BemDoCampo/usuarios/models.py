...
class Usuarios(models.Model):
    ...
    documento = models.CharField(max_length=14, blank=False)
    contato = models.CharField(max_length=11, blank=False)
    ...
    data_cadastro = models.DateTimeField(default=timezone.now() - timedelta(hours=3))
